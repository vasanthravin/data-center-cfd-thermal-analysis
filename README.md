...
### Airflow Streamlines — 3D Animation (Velocity)

<div align="center">

![Streamline Animation](streamline1.gif)

*Figure 9: Animated streamlines colored by velocity magnitude (0–3.1 m/s) showing the three-dimensional airflow path through the data center. Air enters the plenum from both CRAC units, distributes laterally beneath the raised floor, rises through the perforated tiles into the cold aisle, passes through the server racks, and recirculates through the room volume back to the CRAC return intakes. The animation reveals the complete cooling circuit and highlights regions of high velocity at the CRAC discharge and tile openings.*

</div>

---

### Rack Exhaust Temperature — Side View Animation

<div align="center">

![Rack Exhaust Temperature](streamline3.gif)

*Figure 10: Side-view temperature contour on the rear (exhaust) faces of the five server racks in one row. Exhaust temperatures range from approximately 22 °C (yellow, lower rack sections) to 26.9 °C (red, upper rack sections), reflecting the cumulative heat pickup as air passes through the servers. The consistent bottom-to-top gradient across all racks confirms uniform heat generation modeling. The leftmost rack nearest CRAC-1 shows slightly lower exhaust temperatures due to its proximity to the cooling unit.*
